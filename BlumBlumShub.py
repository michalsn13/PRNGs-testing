...
for par in params:
    ...
    print(f'Testing for BlumBlumShub{par} pseudo-random sequence with x0={x0}...')
    sequence=prngs.BlumBlumShub(n*R,x0,par[0])
    ...
    fig.suptitle(f'BlumBlumShub{par} pseudo-random sequence with x0={x0}\n{n} first iterations')
    plt.savefig(f'BlumBlumShub/BlumBlumShub{plot_num}.png')
    fig, axs = plt.subplots(1, 2, figsize=(16, 5))
